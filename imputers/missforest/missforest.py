...
"Some revisions by me since the source file supports only python3 env"

__all__ = ["MissForest"]
__author__ = "Yuen Shing Yan"
__editor__ = "Jinsong Zhen"
...
from imputers.missforest.errors import MultipleDataTypesError, NotFittedError
...
class MissForest:
    ...
    This object is assumed to implement the scikit-learn estimator api.
     ...
     If ``mean``, the initial imputation will use the mean of the features.
    ...
    def fit_transform(self, x, categorical):
        """
